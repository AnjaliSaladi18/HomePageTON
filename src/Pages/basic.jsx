        ...
        <div className="cookies-policy-container">
            ...
            <div className="policy-group">
                <PolicyRow
                    ...
                    description="Cookies are small text files stored on your device by your browser when you visit a website. They help recognize your device and store certain information to make your experience better."
                    checked={toggle1}
                ...
                <PolicyRow
                    ...
                    description="You can choose to disable cookies through your browser settings. However, disabling cookies may impact the functionality and performance of certain features on our platform."
                    checked={toggle3}
